...
import { AddNodeResourceConfigRequest, ModifyResourceResponse, ScaleOutInstanceRequest, DescribeHBaseTableOverviewRequest, DescribeClusterFlowStatusDetailResponse, RunJobFlowResponse, DescribeHDFSStorageInfoResponse, ModifyUserManagerPwdResponse, DescribeHiveQueriesRequest, ModifyPodNumResponse, CreateInstanceResponse, TerminateTasksResponse, CreateGroupsSTDResponse, DescribeServiceNodeInfosRequest, DescribeServiceNodeInfosResponse, ModifyUsersOfGroupSTDRequest, ResetYarnConfigRequest, DescribeTrinoQueryInfoResponse, DescribeSparkQueriesRequest, DeleteAutoScaleStrategyResponse, ModifyPodNumRequest, ModifyResourcesTagsResponse, CreateCloudInstanceResponse, RunJobFlowRequest, DescribeInstanceRenewNodesResponse, DescribeHBaseTableOverviewResponse, DescribeAutoScaleGroupGlobalConfRequest, ModifyAutoScaleStrategyRequest, AttachDisksRequest, DescribeInstancesResponse, DescribeGroupsSTDRequest, ModifyResourceScheduleConfigResponse, DescribeKyuubiQueryInfoResponse, TerminateSLInstanceRequest, AddUsersForUserManagerResponse, DescribeResourceScheduleDiffDetailResponse, DescribeYarnQueueResponse, ScaleOutInstanceResponse, AddMetricScaleStrategyRequest, DeleteNodeResourceConfigRequest, CreateGroupsSTDRequest, DescribeInstanceRenewNodesRequest, DescribeSparkQueriesResponse, DescribeAutoScaleStrategiesResponse, DescribeNodeDataDisksRequest, ModifyGlobalConfigRequest, DescribeInspectionTaskResultRequest, InquiryPriceRenewInstanceResponse, DescribeJobFlowRequest, InquiryPriceCreateInstanceResponse, StartStopServiceOrMonitorRequest, DescribeHDFSStorageInfoRequest, ModifyYarnDeployResponse, DescribeResourceScheduleRequest, ModifySLInstanceResponse, SyncPodStateResponse, TerminateInstanceRequest, DescribeGlobalConfigResponse, ModifyYarnDeployRequest, DeleteNodeResourceConfigResponse, DescribeClusterFlowStatusDetailRequest, DescribeUsersForUserManagerRequest, TerminateClusterNodesResponse, DescribeDAGInfoResponse, DescribeInsightListRequest, DescribeSLInstanceListRequest, StartStopServiceOrMonitorResponse, DescribeHiveQueriesResponse, ResizeDataDisksResponse, DescribeYarnQueueRequest, ModifyResourceRequest, TerminateTasksRequest, CreateSLInstanceResponse, SetNodeResourceConfigDefaultRequest, DescribeYarnScheduleHistoryResponse, DescribeDAGInfoRequest, DescribeAutoScaleGroupGlobalConfResponse, ResetYarnConfigResponse, DescribeClusterNodesResponse, DescribeYarnApplicationsRequest, DescribeYarnScheduleHistoryRequest, DeleteUserManagerUserListRequest, SetNodeResourceConfigDefaultResponse, DescribeResourceScheduleResponse, DescribeNodeResourceConfigFastRequest, ModifyResourceSchedulerRequest, ModifyInspectionSettingsResponse, DescribeKyuubiQueryInfoRequest, ModifyGlobalConfigResponse, DescribeNodeResourceConfigFastResponse, ModifySLInstanceRequest, DescribeInsightListResponse, CreateClusterResponse, DescribeAutoScaleRecordsResponse, ModifyYarnQueueV2Request, DescribeCvmQuotaResponse, CreateClusterRequest, CreateCloudInstanceRequest, AddMetricScaleStrategyResponse, DeleteGroupsSTDResponse, DescribeImpalaQueriesRequest, ModifyInstanceBasicResponse, DescribeInspectionTaskResultResponse, DescribeCvmQuotaRequest, DescribeClusterNodesRequest, CreateInstanceRequest, ScaleOutClusterRequest, DescribeSLInstanceListResponse, DescribeEmrOverviewMetricsResponse, ModifyUserGroupRequest, DescribeInstancesRequest, TerminateSLInstanceResponse, ModifyAutoRenewFlagResponse, InquiryPriceUpdateInstanceRequest, DescribeAutoScaleStrategiesRequest, DeployYarnConfRequest, DescribeGroupsSTDResponse, DescribeNodeDataDisksResponse, DescribeInstancesListRequest, AttachDisksResponse, ResizeDataDisksRequest, DeleteAutoScaleStrategyRequest, DeployYarnConfResponse, DescribeInstancesListResponse, DeleteUserManagerUserListResponse, ModifyResourcePoolsResponse, ModifyUserGroupResponse, DescribeEmrApplicationStaticsRequest, ModifyInstanceBasicRequest, DescribeYarnApplicationsResponse, DescribeUsersForUserManagerResponse, DescribeResourceScheduleDiffDetailRequest, InquiryPriceRenewInstanceRequest, ModifyResourcesTagsRequest, InquirePriceRenewEmrResponse, AddUsersForUserManagerRequest, DescribeSLInstanceRequest, DeleteGroupsSTDRequest, InquiryPriceCreateInstanceRequest, DescribeSLInstanceResponse, SyncPodStateRequest, ModifyAutoRenewFlagRequest, AddNodeResourceConfigResponse, ModifyResourceScheduleConfigRequest, DescribeEmrOverviewMetricsRequest, ScaleOutClusterResponse, InquiryPriceUpdateInstanceResponse, ModifyUsersOfGroupSTDResponse, ModifyAutoScaleStrategyResponse, InquiryPriceScaleOutInstanceRequest, DescribeStarRocksQueryInfoRequest, ModifySLInstanceBasicRequest, DescribeEmrApplicationStaticsResponse, InquirePriceRenewEmrRequest, DescribeImpalaQueriesResponse, ModifySLInstanceBasicResponse, DescribeStarRocksQueryInfoResponse, ModifyYarnQueueV2Response, ModifyUserManagerPwdRequest, InquiryPriceScaleOutInstanceResponse, DescribeJobFlowResponse, ModifyResourceSchedulerResponse, DescribeTrinoQueryInfoRequest, ModifyInspectionSettingsRequest, DescribeAutoScaleRecordsRequest, TerminateClusterNodesRequest, ModifyResourcePoolsRequest, CreateSLInstanceRequest, DescribeGlobalConfigRequest, TerminateInstanceResponse } from "./emr_models";
/**
 * emr client
 * @class
 */
